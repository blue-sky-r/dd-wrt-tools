...
-r[efresh] ... update frequency in seconds, float accepter (default $SLEEP)
...
Note: the beep freq. formula (Q is the signal quality between 0..100):

    frequency = offset + 10 * Q * mult
